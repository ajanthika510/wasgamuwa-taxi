...
export default function BookingCard({
  ...
  const getInitialFormData = () => ({
    ...
    time: "",
    travellers: bookingData?.travellers || "1 Traveller",
  });
  ...
  const handleWhatsApp = () => {
    if (
      ...
      alert("Please fill all booking details before continuing.");
      return;
    }
